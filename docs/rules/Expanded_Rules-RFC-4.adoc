...
[red-background]#This RFC adjusts the rule on Focus, relying on communication with WotC right at the game's end, along with the general norm of how the majority have been playing, suggesting the current rule text is the less simple path. See <<_flip_battle_cards,Flip Battle Cards>>. #
...
. [red-background]#DELETED:Any abilities that happen “before flipping battling cards,” like Focus, resolve.#
...
. The attacking player flips battle cards. [yellow-background]#Before flipping, any abilities that happen “before flipping battling cards,” like Focus, resolve.# To flip a battle card, the player takes the top card of their deck and puts it face up into their played area.
...
. The defending player flips battle cards. [yellow-background]#Before flipping, any abilities that happen “before flipping battling cards,” like Focus, resolve.# [red-background]#DELETED:including the white battle icon “bonus flip,” if applicable.#
...
* [yellow-background]#If the defending player flips a white battle icon, they flip two additional cards. There is no additional bonus for additional white battle icons beyond the first.#
