...
[red-background]#This RFC adjusts the rule on Focus, based on communication with WotC around the game's end. Additionally, the general norm of how the majority have been playing suggests this is the simple and expected approach. See <<_flip_battle_cards,Flip Battle Cards>>. #
