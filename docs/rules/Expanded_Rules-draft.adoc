...
[yellow-background]#An Upgrade can only be put on a character if the character has a slot of the appropriate type.#

[yellow-background]#When an Upgrade is put on a character, events occur in the following order:#

* [yellow-background]#The player chooses a slot of the appropriate type for that upgrade to occupy and puts the upgrade into that slot.  This slot usually matches the type of the upgrade.#
* [yellow-background]#If the character now has too many Upgrades in that slot, Upgrades previously on the character in that slot are scrapped until there are no longer too many Upgrades for the slot.#
* [yellow-background]#If this upgrade was played as part of the resolution of an action or triggered ability, any abilities that trigger due to this upgrade being put on a character wait until the current action or triggered ability finishes resolving.#
* [yellow-background]#Any triggered abilities of the active player resolve in the order of their choice.#
* [yellow-background]#Any triggered abilities of the nonactive player resolve in the order of their choice.#

[yellow-background]#_Example_: Your character with 10 HP has 11 damage and is equipped with a Minor Medic Kit (+2HP). You decide to upgrade the character with an Enhanced Power Cell (+3HP). The Power Cell is added to your character, then the Medic Kit is removed. Your character is not KO'd.#

== Errata

=== All Out Attack (W1C-001)

The original conference version of All Out Attack used the term Transformers instead of characters. This was fixed in the Energon Edition reprint. +++<del>+++, thus the original conference version now says:+++</del>+++

+++<del>+++"Each of your untapped characters can attack this turn."+++</del>+++

[yellow-background]#Its text is also a poor fit with the concept of an Extra Attack. It is Errata'd to have the following interpretation:#
