...
The original conference version of All Out Attack used the term Transformers instead of characters. This was fixed in the Energon Edition reprint, thus the original conference version now says:

    "Each of your untapped characters can attack this turn."
