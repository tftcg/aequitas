...
. The attacking player flips battle cards. Before flipping, any abilities that happen “before flipping battling cards,” like Focus, resolve. To flip a battle card, the player takes the top card of their deck and puts it face up into their played area.
...
. The defending player flips battle cards. Before flipping, any abilities that happen “before flipping battling cards,” like Focus, resolve.
...
. Reveals all face down Secret Actions.
