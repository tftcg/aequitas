...
. [yellow-background]#If, as a result of having extra attacks, the attacking player either must, or chooses, to attack again they return to the “3. Attack” phase above.#
...
All-Out Attack:: 
[yellow-background]#Until end of turn -> When one of your characters attacks, you may attack with another character that has not already attacked this turn.#
