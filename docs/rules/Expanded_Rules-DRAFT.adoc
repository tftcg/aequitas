= Transformers TCG: Expanded Rules 2.0.1
...
:toclevels: 3
:sectnums:
:toc-title: Expanded Rules 2.0.1
:imagesdir: ./images
...
The attack is divided into three steps. [yellow-background]#The attack may consume the turn’s required attack, or may use an extra attack supplied by a card.#
...
. [yellow-background]#The attacking player returns to the “3. Attack” phase above, if they have mandatory extra attacks; or they have used only extra attacks thus far this turn, and they choose to return.#
