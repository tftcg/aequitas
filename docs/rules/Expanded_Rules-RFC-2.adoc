...
This RFC introduces rules for Stratagem targets. 
...
* A specifically named character on your starting team (i.e. "Optimus Prime - Battlefield Legend").
* A generally named character on your starting team (i.e. "Optimus Prime").
* A combiner that a character on your starting team could combine into.
* A character your starting team could deploy.
* A trait on any of the above.   [what about another mode???]
