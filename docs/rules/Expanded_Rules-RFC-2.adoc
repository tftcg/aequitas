...
This RFC introduces rules identifying legal Stratagem Targets. See <<_stratagem_targets,Stratagem Targets>> for the new text. 
...
* [yellow-background]#A combiner that a character on your starting team could combine into.#
* [yellow-background]#A character your starting team could deploy.#
* [yellow-background]#A trait on any of the above.   [what about another mode???]#
